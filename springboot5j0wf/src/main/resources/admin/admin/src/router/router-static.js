...
import center from '@/views/center'
    import discusswuzizixun from '@/views/modules/discusswuzizixun/list'
    import wuzizixun from '@/views/modules/wuzizixun/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/discusswuzizixun',
        name: '物资资讯评论',
        component: discusswuzizixun
      }
      ,{
	path: '/wuzizixun',
        name: '物资资讯',
