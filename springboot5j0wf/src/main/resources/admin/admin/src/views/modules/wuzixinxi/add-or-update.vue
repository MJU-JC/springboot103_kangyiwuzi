<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物资分类" prop="wuzifenlei">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/wuzifenlei/wuzifenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.wuzifenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.wuzixiangqing = this.ruleForm.wuzixiangqing.replace(reg,'../../../springboot5j0wf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
